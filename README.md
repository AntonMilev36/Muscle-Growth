...
## Goal
The goal of the project is to find a way to calculate the most optimal sets and training sessions for every individual.
...
## Resources
All resources are placed in the .ipynb files in places where they'll make sence, but if you want to check all, they are in the resources.txt
